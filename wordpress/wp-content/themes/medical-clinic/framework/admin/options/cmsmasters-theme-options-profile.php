...
if (!function_exists('medical_clinic_get_custom_profile_meta_fields')) {
function medical_clinic_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['medical-clinic' . '_profile_post_title']) && $cmsmasters_option['medical-clinic' . '_profile_post_title'] !== '') ? (($cmsmasters_option['medical-clinic' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['medical-clinic' . '_profile_post_details_title']) && $cmsmasters_option['medical-clinic' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['medical-clinic' . '_profile_post_details_title'] : '';
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['medical-clinic' . '_profile_post_share_box']) && $cmsmasters_option['medical-clinic' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['medical-clinic' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'medical-clinic'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'medical-clinic'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'medical-clinic'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'medical-clinic'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'medical-clinic'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'medical-clinic'), 
			'desc'	=> '', 
