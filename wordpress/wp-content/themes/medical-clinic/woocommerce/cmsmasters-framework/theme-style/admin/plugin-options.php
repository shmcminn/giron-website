...
/* Filter for Options */
function medical_clinic_woocommerce_meta_fields($custom_all_meta_fields) {
...
add_filter('get_custom_all_meta_fields_filter', 'medical_clinic_woocommerce_meta_fields');
