...
/* Unregister Sidebar */
function medical_clinic_timetable_booking_popup($cmsmasters_option) {
	echo "<div class='tt_booking tt_hide'>
...
add_action('cmsmasters_before_page', 'medical_clinic_timetable_booking_popup');
